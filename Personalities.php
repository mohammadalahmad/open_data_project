            ...
            <?php 
                ...
                if (!empty($firstname) and !empty($lastname) and !empty($job)) {
                    ...
                    echo '<script type="text/JavaScript">  
                                 alert("Informationen wurden gesendet");
                          </script>' ; 
                    } else {
        ...
        <div style="background-color:#e3f2fd;" class = "p-4   rounded">
            ...
            <?php  #javascript  ?>
                <div class="input-group">
                     <div class="col-md-3">
                        <input id="firstNameInput"      placeholder="Firstname" name="firstname" type="text" class="form-control  <?php echo $valid_or_notValid; ?>" aria-describedby="validationServer05Feedback" required>
